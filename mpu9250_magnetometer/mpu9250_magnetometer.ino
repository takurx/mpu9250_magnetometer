/*
 * MPU-9250 and Arduino pro micro magnetometer test V0.1
 * takuzirra@twitter
...
void loop()
{
  ...
  double perpendicular = (double)(az) / (double)(max_acc) * (double)(180.0);
  if(perpendicular > 180)
  {
    perpendicular = 180.0;  
  }
  
  Serial.print(perpendicular, 4);
  Serial.print("\t");
...
　*/
  ...
  */
  ...
  Serial.print ("\t");
  /*
  Serial.print (my+500,DEC);
  Serial.print ("\t");
  Serial.print (mz+500,DEC);  
  Serial.print ("\t");
  */
